...
export default function Classrooms({ 
 ...
 <tr>
 <th className="px-6 py-4 font-semibold text-foreground">{t('classroom_name')}</th>
 <th className="px-6 py-4 font-semibold text-foreground">{t('course')}</th>
 <th className="px-6 py-4 font-semibold text-foreground">{t('teacher')}</th>
 <th className="px-6 py-4 font-semibold text-foreground text-center">{t('students')}</th>
 ...
 <span className="text-muted-foreground text-xs">{t('no_course')}</span>
 )}
 </td>
 <td className="px-6 py-4">
 ...
 <p className="font-medium text-foreground">{search ? t('no_classrooms_found') : t('no_classrooms_registered')}</p>
 <p className="text-xs">{search ? t('try_adjusting_search') : t('create_new_classroom_start')}</p>
 </div>
 </td>
 </tr>
 )}
