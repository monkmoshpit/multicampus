                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <header className="flex flex-col gap-1">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Manage your enrolled students and academic grades.
                        </p>
                    </header>
                    <Button
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="text-xs uppercase bg-muted/40 text-muted-foreground border-b border-border">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 font-semibold text-foreground">Grade Level</th>
                                    ...
                                    <tr>
                                        <td colSpan={3} className="px-6 py-12 text-center text-muted-foreground">
                                            <div className="flex flex-col items-center justify-center space-y-3">
                                                ...
                                                <p className="font-medium text-foreground">{search ? 'No students found' : 'No students registered'}</p>
                                                <p className="text-xs">{search ? 'Try adjusting your search query' : 'Add a new student to get started'}</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
                    ...
                    <DialogContent className="sm:max-w-md border-border bg-popover">
                        <DialogHeader>
                            ...
                            <p className="text-sm text-muted-foreground">
                                {editingStudent ? 'Update the details for this enrolled student.' : 'Enter the details for the new student.'}
                            </p>
                        </DialogHeader>
                        <Form 
                        ...
                        >
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="grade" className="text-sm font-medium text-foreground">Grade Level</Label>
                                <Input
                                    id="grade"
                                    name="grade"
